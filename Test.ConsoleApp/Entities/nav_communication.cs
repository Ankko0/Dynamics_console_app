...
namespace Dynamics.ConsoleApp.Entities
{
	...
	public partial class nav_communication : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Dynamics.ConsoleApp.Entities.nav_communicationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Dynamics.ConsoleApp.Entities.nav_communicationState)(System.Enum.ToObject(typeof(Dynamics.ConsoleApp.Entities.nav_communicationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Dynamics.ConsoleApp.Entities.Contact nav_contact_nav_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Dynamics.ConsoleApp.Entities.Contact>("nav_contact_nav_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_communication_contactid");
				this.SetRelatedEntity<Dynamics.ConsoleApp.Entities.Contact>("nav_contact_nav_communication_contactid", null, value);
